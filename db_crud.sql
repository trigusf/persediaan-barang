...
--
-- Host: localhost
-- Generation Time: Dec 24, 2025 at 11:47 AM
...
INSERT INTO `barang_masuk` (`id_barang_masuk`, `id_user`, `tgl_barang_masuk`, `total`) VALUES
(1, 2, '2025-12-22', 840000);
...
(5, 6, 'VT-003', 'Keyboard Vortex Mono Series V2', 380000, 0);
...
INSERT INTO `detail_barang_masuk` (`id_detail_masuk`, `id_barang_masuk`, `id_distributor`, `id_barang`, `qty`, `subtotal`) VALUES
(1, 1, 4, 2, 1, 570000),
(2, 1, 6, 4, 1, 270000);
...
ALTER TABLE `detail_barang_keluar`
  ...
  ADD UNIQUE KEY `id_barang_keluar` (`id_barang_keluar`,`id_distributor`,`id_barang`),
...
ALTER TABLE `detail_barang_masuk`
  ...
  ADD UNIQUE KEY `id_barang_masuk` (`id_barang_masuk`,`id_distributor`,`id_barang`),
  ADD KEY `id_barang` (`id_barang`),
  ADD KEY `id_distributor` (`id_distributor`);
...
--
ALTER TABLE `detail_barang_masuk`
  MODIFY `id_detail_masuk` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
ALTER TABLE `detail_barang_keluar`
  ...
  ADD CONSTRAINT `detail_barang_keluar_ibfk_2` FOREIGN KEY (`id_barang`) REFERENCES `data_barang` (`id_barang`),
  ADD CONSTRAINT `detail_barang_keluar_ibfk_3` FOREIGN KEY (`id_distributor`) REFERENCES `data_distributor` (`id_distributor`);
...
ALTER TABLE `detail_barang_masuk`
  ...
  ADD CONSTRAINT `detail_barang_masuk_ibfk_2` FOREIGN KEY (`id_barang`) REFERENCES `data_barang` (`id_barang`),
  ADD CONSTRAINT `detail_barang_masuk_ibfk_3` FOREIGN KEY (`id_distributor`) REFERENCES `data_distributor` (`id_distributor`);
COMMIT;
